    ...
    <div class="container y-scroll scroll">
        ...
        <input type="text" id="search" placeholder="Rechercher un employé">
            <table class="table" id="table-leave">
                <thead class="thead">
                    <tr class="trthead">
                        <th scope="col" class="ththead">Nom</th>
                        <th scope="col" class="ththead">Date demande</th>
                        <th scope="col" class="ththead">Date debut</th>
                        <th scope="col" class="ththead">Date fin</th>
                        <th scope="col" class="ththead">Durée</th>
                        <th scope="col" class="ththead">Type congés</th>
                        <th scope="col" class="ththead">Motif</th>
                        <th scope="col" class="ththead">Commentaire</th>
                        <th scope="col" class="ththead">Gestionnaire</th>
                        <th scope="col" class="ththead">Actions</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php endwhile ;?>
                    <?php if ($conges->rowCount() == 0): ?>
                        <tr class="empty-message">
                            <td colspan="8"><h1 style="color:#555;">Aucune demande de congé n'a été faite.</h1></td>
                        </tr>
                    <?php endif; ?> 
                </tbody>
            </table>
