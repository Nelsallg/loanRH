...
<body>
    <div class="container-parent col-12">
        ...
        <div class="container col-6">
            ...
            <h1 class="page-title">Champ de Sélection et d'Envoi de Fichiers</h1>
            <form method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="champsSelect">Sélectionnez l'employé :</label>
                    <select name="numero_securite_sociale" id="id_employe" class="form-control">
                        <option value="">--------</option>
                ...
                <div class="form-group">
                    <label for="champsSelect">Sélectionnez le type de fichier :</label>
